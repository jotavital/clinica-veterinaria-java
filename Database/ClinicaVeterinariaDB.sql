...
CREATE TABLE IF NOT EXISTS `ClinicaVeterinariaDB`.`consulta` (
  ...
  PRIMARY KEY (`id`),
  INDEX `consulta_fk0` (`fk_animal` ASC) VISIBLE,
  INDEX `consulta_fk1` (`fk_atendente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ClinicaVeterinariaDB`.`cliente_animal` (
  ...
  INDEX `cliente_animal_fk1` (`fk_animal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ClinicaVeterinariaDB`.`veterinario_consulta` (
  ...
  INDEX `veterinario_consulta_fk1` (`fk_consulta` ASC) VISIBLE,
